...
export const Sidebar = (): JSX.Element => {
    ...
    return (
        <aside className={`flex ${expand ? 'w-[300px]' : 'w-[95px]' } h-screen border border-solid border-gray-200 flex-col bg-gray-50 gap-2 justify-between`}>
        <div className='relative'>
            <header className='flex items-center justify-center py-3'>
                <Image src={logo} alt='KSX' className='place-self-center'/>
            </header>
            {expand && (
                    <button className='absolute top-10 z-10' style={{left: '285px'}}>

...
export const Pagination = ({ page }: PageProps): React.JSX.Element => {
  return (
    <div className="flex p-3 items-center justify-between gap-4 w-full">
      <section className="flex gap-3 items-center">
        <p className="text-gray-400 font-semibold">View</p>
        <input
          type="number"
          value={10}
        ...
        />
        <p className="text-gray-400 font-semibold">Employees per page</p>
